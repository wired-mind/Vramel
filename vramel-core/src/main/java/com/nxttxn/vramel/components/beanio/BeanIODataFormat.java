 ...
 */
package com.nxttxn.vramel.components.beanio;
 ...
 */
public class BeanIODataFormat extends ServiceSupport implements DataFormat, VramelContextAware {
    ...
    private transient VramelContext vramelContext;
    ...
    protected void doStart() throws Exception {
        ...
        if (factory == null) {
            ...
            InputStream is = ResourceHelper.resolveMandatoryResourceAsInputStream(getVramelContext().getClassResolver(), mapping);
            try {
                factory.load(is);
            } finally {
                IOHelper.close(is);
