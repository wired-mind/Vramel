...
public class MethodInfoCache {
    ...
    public MethodInfoCache(VramelContext vramelContext) {
        this(vramelContext, 1000, 10000);
    }

    public MethodInfoCache(VramelContext vramelContext, int classCacheSize, int methodCacheSize) {
        this(vramelContext, createClassCache(classCacheSize), createMethodCache(methodCacheSize));
    }

    public MethodInfoCache(VramelContext vramelContext, Map<Class<?>, BeanInfo> classCache, Map<Method, MethodInfo> methodCache) {
    ...
    protected BeanInfo createBeanInfo(Class<?> declaringClass) {
        return new BeanInfo(vramelContext, declaringClass);
    }
