    ...
    protected Object invokeWithBody(final Method method, Object body, final ExchangePattern pattern) throws Throwable {
        ...
        FutureTask<Object> task = new FutureTask<Object>(new Callable<Object>() {
            public Object call() throws Exception {
                ...
                throw new UnsupportedOperationException("This code will need to be tested");
//                producer.process(exchange, new OptionalAsyncResultHandler() {
//                    @Override
...
//                return answer;
        ...
        if (cause != null) {
            ...
            if (found != null) {
                if (found instanceof Exception) {
                    ...
                    // wrap as exception
                    throw new VramelExchangeException("Error processing exchange", exchange, cause);
                }
            }
            // special for runtime camel exceptions as they can be nested
            if (cause instanceof RuntimeVramelException) {
                // if the inner cause is a runtime exception we can throw it
                // directly
                if (cause.getCause() instanceof RuntimeException) {
                    throw (RuntimeException)((RuntimeVramelException)cause).getCause();
                }
                throw (RuntimeVramelException)cause;
            }
    ...
    protected static Class<?> getGenericType(VramelContext context, Type type) throws ClassNotFoundException {
        if (type == null) {
    ...
    protected static synchronized ExecutorService getExecutorService(VramelContext context) {
