...
public class XMLSecurityDataFormat implements DataFormat, VramelContextAware {
    ...
    public void setVramelContext(VramelContext vramelContext) {
        ...
        try {
            setDefaultsFromContext(vramelContext);

        } catch (Exception e) {
            throw new IllegalStateException("Could not initialize XMLSecurityDataFormat with vramelContext. ", e);
        }
    }
     ...
     */
    @Deprecated
    private void setDefaultsFromContext(VramelContext context) throws Exception {
    ...
    public void setKeyOrTrustStoreParametersId(String registryId) {
        ...
        if (vramelContext != null) {
            Object parametersObj = vramelContext.getRegistry().lookupByName(this.keyOrTrustStoreParametersId);
            if (parametersObj instanceof KeyStoreParameters) {
                this.keyOrTrustStoreParameters = (KeyStoreParameters)parametersObj;
            } else {
                throw new IllegalStateException("Could not initialize XMLSecurityDataFormat with vramelContext."
