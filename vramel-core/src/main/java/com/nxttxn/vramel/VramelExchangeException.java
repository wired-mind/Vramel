 ...
 * @version
 */
public class VramelExchangeException extends VramelException {

    // exchange is not guaranteed to be serializable so we set it as transient
    private final transient Exchange exchange;

    public VramelExchangeException(String message, Exchange exchange) {
        super(VramelExchangeException.createExceptionMessage(message, exchange, null));
        this.exchange = exchange;
    }

    public VramelExchangeException(String message, Exchange exchange, Throwable cause) {
        super(VramelExchangeException.createExceptionMessage(message, exchange, cause), cause);
        this.exchange = exchange;
    }
