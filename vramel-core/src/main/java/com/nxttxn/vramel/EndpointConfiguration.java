...
public interface EndpointConfiguration {
     ...
     * @return the configuration URI.
     * @throws RuntimeVramelException is thrown if error getting the parameter
     */
    <T> T getParameter(String name) throws RuntimeVramelException;
     ...
     * @throws RuntimeVramelException is thrown if error setting the parameter
     */
    <T> void setParameter(String name, T value) throws RuntimeVramelException;
