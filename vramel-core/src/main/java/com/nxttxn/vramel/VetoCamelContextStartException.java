...
/**
 * An exception to veto starting {@link VramelContext}.
 * <p/>
...
public class VetoCamelContextStartException extends Exception {
    ...
    public VetoCamelContextStartException(String message, VramelContext context) {
        this(message, context, true);
    }

    public VetoCamelContextStartException(String message, VramelContext context, boolean rethrowException) {
        super(message);
        this.context = context;
        this.rethrowException = rethrowException;
    }

    public VetoCamelContextStartException(String message, Throwable cause, VramelContext context) {
        this(message, cause, context, true);
    }

    public VetoCamelContextStartException(String message, Throwable cause, VramelContext context, boolean rethrowException) {
        super(message, cause);
        this.context = context;
        this.rethrowException = rethrowException;
    }
