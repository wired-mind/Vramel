...
import com.nxttxn.vramel.processor.OnCompletionProcessor;
...
public class OnCompletionDefinition extends ProcessorDefinition<OnCompletionDefinition> {
    ...
    public boolean getFlowScoped() {
        // is context scoped by default
        return flowScoped != null ? flowScoped : false;
    }

    public Processor getOnCompletion(String flowId) {
        return onCompletions.get(flowId);
    }
    ...
    public Processor createProcessor(FlowContext flowContext) throws Exception {
        ...
        childProcessor = new UnitOfWorkProcessor(flowContext, childProcessor);
        ...
        OnCompletionProcessor answer = new OnCompletionProcessor(flowContext.getVramelContext(), childProcessor, isOnCompleteOnly(), isOnFailureOnly(), when, original);
        return answer;
    }
