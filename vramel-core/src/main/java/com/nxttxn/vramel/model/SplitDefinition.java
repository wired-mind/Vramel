...
public class SplitDefinition extends ExpressionNode implements {
    ...
    private AggregationStrategy createAggregationStrategy(FlowContext routeContext) {
        AggregationStrategy strategy = getAggregationStrategy();
        if (strategy == null && strategyRef != null) {
            strategy = VramelContextHelper.mandatoryLookup(routeContext.getVramelContext(), strategyRef, AggregationStrategy.class);
        }
        return strategy;
    }
