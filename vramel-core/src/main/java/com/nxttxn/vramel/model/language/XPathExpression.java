...
public class XPathExpression extends NamespaceAwareExpression {
    ...
    public Expression createExpression(VramelContext vramelContext) {
        ...
        resolveXPathFactory(vramelContext);
    ...
    public Predicate createPredicate(VramelContext vramelContext) {
        resolveXPathFactory(vramelContext);
        return super.createPredicate(vramelContext);
    }
    ...
    private void resolveXPathFactory(VramelContext vramelContext) {
        ...
        if (ObjectHelper.isNotEmpty(factoryRef)) {
            xpathFactory = vramelContext.getRegistry().lookupByNameAndType(factoryRef, XPathFactory.class);
            if (xpathFactory == null) {
