...
public final class EndpointHelper {
     ...
     */
    public static boolean matchEndpoint(VramelContext context, String uri, String pattern) {
        if (context != null) {
            try {
     ...
     */
    public static void setProperties(VramelContext context, Object bean, Map<String, Object> parameters) throws Exception {
     ...
     * @throws Exception is thrown if setting property fails
     */
    public static void setReferenceProperties(VramelContext context, Object bean, Map<String, Object> parameters) throws Exception {
     ...
     */
    public static <T> T resolveReferenceParameter(VramelContext context, String value, Class<T> type) {
     ...
     */
    public static <T> T resolveReferenceParameter(VramelContext context, String value, Class<T> type, boolean mandatory) {
        String valueNoHash = value.replaceAll("#", "");
        if (mandatory) {
            return VramelContextHelper.mandatoryLookup(context, valueNoHash, type);
        } else {
            return VramelContextHelper.lookup(context, valueNoHash, type);
        }
    }
    ...
    public static <T> List<T> resolveReferenceListParameter(VramelContext context, String value, Class<T> elementType) {
        if (value == null) {
    ...
    public static String getRouteIdFromEndpoint(Endpoint endpoint) {
        ...
        List<Flow> flows = endpoint.getVramelContext().getFlows();
        for (Flow flow : flows) {
            if (flow.getEndpoint().equals(endpoint)
                    || flow.getEndpoint().getEndpointKey().equals(endpoint.getEndpointKey())) {
                return flow.getId();
            }
        }
        return null;
    ...
    public static String lookupEndpointRegistryId(Endpoint endpoint) {
        ...
        Map<String, Endpoint> map = endpoint.getVramelContext().getRegistry().findByTypeWithName(Endpoint.class);
