 ...
 * @version
 */
public class VramelLogger {
    private Logger log;
    private LoggingLevel level;
    private Marker marker;

    public VramelLogger() {
        this(LoggerFactory.getLogger(VramelLogger.class));
    }

    public VramelLogger(Logger log) {
        this(log, LoggingLevel.INFO);
    }

    public VramelLogger(Logger log, LoggingLevel level) {
        this(log, level, null);
    }

    public VramelLogger(Logger log, LoggingLevel level, String marker) {
        this.log = log;
        setLevel(level);
        setMarker(marker);
    }

    public VramelLogger(String logName) {
        this(LoggerFactory.getLogger(logName));
    }

    public VramelLogger(String logName, LoggingLevel level) {
        this(logName, level, null);
    }

    public VramelLogger(String logName, LoggingLevel level, String marker) {
    ...
    public boolean shouldLog() {
        return VramelLogger.shouldLog(log, level);
    }
