...
import com.nxttxn.vramel.impl.ParameterConfiguration;
...
public interface ComponentConfiguration {
     ...
     * configuration which can then be used to create an {@link Endpoint}
     */
    String getUriString();
    ...
    /**
     * Converts the configuration into a URI and then looks up the endpoint in the {@link VramelContext}
     ...
     * @param name     the name of the URI query parameter
     * @return the value of the parameter
     * @throws RuntimeVramelException if the parameter name does not exist on the endpoint
     */
    Object getEndpointParameter(Endpoint endpoint, String name) throws RuntimeVramelException;
     ...
     * @throws RuntimeVramelException
     */
    void setEndpointParameter(Endpoint endpoint, String name, Object value) throws RuntimeVramelException;
