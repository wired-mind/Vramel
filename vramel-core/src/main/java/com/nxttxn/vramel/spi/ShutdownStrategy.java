...
public interface ShutdownStrategy extends Service {
     ...
     * <p/>
     * This operation is used when {@link VramelContext} is shutting down, to ensure Camel will shutdown
     ...
     */
    void shutdownForced(VramelContext context, List<RouteStartupOrder> routes) throws Exception;
     ...
     * @throws Exception is thrown if error shutting down the consumers, however its preferred to avoid this
     */
    void shutdown(VramelContext context, List<RouteStartupOrder> routes) throws Exception;
     ...
     */
    void suspend(VramelContext context, List<RouteStartupOrder> routes) throws Exception;
     ...
     * @throws Exception is thrown if error shutting down the consumers, however its preferred to avoid this
     */
    void shutdown(VramelContext context, List<RouteStartupOrder> routes, long timeout, TimeUnit timeUnit) throws Exception;
     ...
     */
    boolean shutdown(VramelContext context, RouteStartupOrder route, long timeout, TimeUnit timeUnit, boolean abortAfterTimeout) throws Exception;
     ...
     * @throws Exception is thrown if error suspending the consumers, however its preferred to avoid this
     */
    void suspend(VramelContext context, List<RouteStartupOrder> routes, long timeout, TimeUnit timeUnit) throws Exception;
     ...
     * keep running and is halted abruptly when {@link VramelContext} has been shutdown.
     *
