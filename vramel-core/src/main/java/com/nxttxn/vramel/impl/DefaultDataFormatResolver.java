...
import com.nxttxn.vramel.spi.DataFormatResolver;
...
public class DefaultDataFormatResolver implements DataFormatResolver {
    ...
    public static final String DATAFORMAT_RESOURCE_PATH = "META-INF/services/com/nxttxn/vramel/dataformat/";

    protected FactoryFinder dataformatFactory;

    public DataFormat resolveDataFormat(String name, VramelContext context) {
