...
import com.nxttxn.vramel.EndpointInject;
import com.nxttxn.vramel.Produce;
import com.nxttxn.vramel.VramelContext;
import com.nxttxn.vramel.VramelContextAware;
import com.nxttxn.vramel.util.ObjectHelper;
import com.nxttxn.vramel.util.ReflectionHelper;
...
public class DefaultCamelBeanPostProcessor {
    ...
    protected VramelContext vramelContext;

    public DefaultCamelBeanPostProcessor() {
    }

    public DefaultCamelBeanPostProcessor(VramelContext vramelContext) {
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws Exception {
        ...
        if (bean instanceof VramelContextAware && canSetCamelContext(bean, beanName)) {
            VramelContextAware contextAware = (VramelContextAware)bean;
            VramelContext context = getOrLookupCamelContext();
            if (context == null) {
                LOG.warn("No CamelContext defined yet so cannot inject into bean: " + beanName);
            } else {
                contextAware.setVramelContext(context);
            }
        }
    ...
    /**
     * Strategy to get the {@link VramelContext} to use.
     */
    public VramelContext getOrLookupCamelContext() {
    ...
    protected boolean canSetCamelContext(Object bean, String beanName) {
        if (bean instanceof VramelContextAware) {
            VramelContextAware camelContextAware = (VramelContextAware) bean;
            VramelContext context = camelContextAware.getVramelContext();
            if (context != null) {
