...
import com.nxttxn.vramel.spi.UriParams;
...
public abstract class UriEndpointComponent extends DefaultComponent {
    ...
    public UriEndpointComponent(VramelContext context, Class<? extends Endpoint> endpointClass) {
        super(context);
     ...
     * {@link com.nxttxn.vramel.spi.UriEndpoint}, {@link com.nxttxn.vramel.spi.UriParam}, {@link com.nxttxn.vramel.spi.UriParams}
     */
