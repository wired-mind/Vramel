...
public class UriComponentConfiguration extends ComponentConfigurationSupport {
    ...
    @Override
    public Object getEndpointParameter(Endpoint endpoint, String name) throws RuntimeVramelException {
        ...
        try {
            ...
            throw new RuntimeVramelException(
    ...
    @Override
    public void setEndpointParameter(Endpoint endpoint, String name, Object value) throws RuntimeVramelException {
        ParameterConfiguration config = getParameterConfiguration(name);
        ...
        try {
            ...
            throw new RuntimeVramelException("Failed to set property '" + name + "' on " + endpoint + " to value "
    ...
    public VramelContext getVramelContext() {
        return component.getVramelContext();
    }
    ...
    protected Object validatePropertyValue(String name, Object value) {
        ...
        if (parameterConfiguration == null) {
            ...
            return getVramelContext().getTypeConverter().convertTo(parameterType, value);
        }
    }
