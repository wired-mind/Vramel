...
import com.nxttxn.vramel.util.ReflectionInjector;
...
public class DefaultInjector implements Injector {
    ...
    public DefaultInjector(VramelContext context) {
    ...
    public <T> T newInstance(Class<T> type) {
        ...
        if (answer != null) {
            try {
                ...
                throw new RuntimeVramelException("Error during post processing of bean " + answer, e);
            }
        }
        return answer;
    }
