...
public interface ProducerTemplate extends Service {
     ...
     */
    void sendBody(Object body) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeader(Object body, String header, Object headerValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndProperty(Object body, String property, Object propertyValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeaders(Object body, Map<String, Object> headers) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBody(Endpoint endpoint, Object body) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeader(String endpointUri, Object body, String header, Object headerValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeader(Endpoint endpoint, Object body, String header, Object headerValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndProperty(String endpointUri, Object body, String property, Object propertyValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndProperty(Endpoint endpoint, Object body, String property, Object propertyValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeaders(String endpointUri, Object body, Map<String, Object> headers) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeaders(Endpoint endpoint, Object body, Map<String, Object> headers) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBody(Object body) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T requestBody(Object body, Class<T> type) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBody(Endpoint endpoint, Object body) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T requestBody(Endpoint endpoint, Object body, Class<T> type) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBody(String endpointUri, Object body) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T requestBody(String endpointUri, Object body, Class<T> type) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeader(Object body, String header, Object headerValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeader(Endpoint endpoint, Object body, String header, Object headerValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T requestBodyAndHeader(Endpoint endpoint, Object body, String header, Object headerValue, Class<T> type) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeader(String endpointUri, Object body, String header, Object headerValue) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T requestBodyAndHeader(String endpointUri, Object body, String header, Object headerValue, Class<T> type) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeaders(String endpointUri, Object body, Map<String, Object> headers) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T requestBodyAndHeaders(String endpointUri, Object body, Map<String, Object> headers, Class<T> type) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeaders(Endpoint endpoint, Object body, Map<String, Object> headers) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeaders(Object body, Map<String, Object> headers) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T requestBodyAndHeaders(Endpoint endpoint, Object body, Map<String, Object> headers, Class<T> type) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T extractFutureBody(Future<Object> future, Class<T> type) throws VramelExecutionException;
     ...
     * @throws VramelExecutionException if the processing of the exchange failed
     */
    <T> T extractFutureBody(Future<Object> future, long timeout, TimeUnit unit, Class<T> type) throws TimeoutException, VramelExecutionException;
